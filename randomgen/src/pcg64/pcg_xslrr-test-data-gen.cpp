// gcc pcg64-xsl_rr-test-data-gen.cpp /O2
...
int main() {
  ...
  pcg_engines::setseq_xsl_rr_128_64 rng(seed, 0U);
  pcg_engines::cm_setseq_xsl_rr_128_64 cm_rng(seed, 0U);
  cout << rng << "\n";
  cout << cm_rng << "\n";
  ...
  rng = pcg_engines::setseq_xsl_rr_128_64(seed, 0U);
  cm_rng = pcg_engines::cm_setseq_xsl_rr_128_64(seed, 0U);
