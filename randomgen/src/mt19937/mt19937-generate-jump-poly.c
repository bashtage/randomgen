...
int main(void) {
  int k, i, a = 0;
  char steps[5][45] = {"340282366920938463463374607431768211456",
                       "5444517870735015415413993718908291383296",
                       "87112285931760246646623899502532662132736",
                       "1393796574908163946345982392040522594123776",
                       "22300745198530623141535718272648361505980416"};
  char file_names[5][14] = {"poly-128.txt", "poly-132.txt", "poly-136.txt",
                            "poly-140.txt", "poly-144.txt"};
  for (k = 0; k < 5; k++) {
    cout << k;
    ZZ jump_step =
        conv<ZZ>(steps[k]); /* the number of steps of jumping ahead */
