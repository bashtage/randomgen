...
cdef class Generator:
    ...
    **No Compatibility Guarantee**
    ...
    def binomial(self, n, p, size=None):
        ...
        n_arr = <np.ndarray>np.PyArray_FROM_OTF(n, np.NPY_INT64, api.NPY_ARRAY_ALIGNED)
    ...
    def hypergeometric(self, ngood, nbad, nsample, size=None):
        ...
        ongood = <np.ndarray>np.PyArray_FROM_OTF(ngood, np.NPY_INT64, api.NPY_ARRAY_ALIGNED)
        onbad = <np.ndarray>np.PyArray_FROM_OTF(nbad, np.NPY_INT64, api.NPY_ARRAY_ALIGNED)
        onsample = <np.ndarray>np.PyArray_FROM_OTF(nsample, np.NPY_INT64, api.NPY_ARRAY_ALIGNED)
