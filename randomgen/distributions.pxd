...
cdef extern from "src/distributions/distributions.h":
    ...
    uint32_t random_buffered_bounded_uint32(brng_t *brng_state, uint32_t off,
                                                ...
                                                int *bcnt, uint32_t *buf, bint use_masked_generator) nogil
