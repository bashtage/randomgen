...
class RandomState:
    ...
    def get_state(self, legacy: bool = True): ...
    def set_state(self, state) -> None: ...
    def random_sample(self, size: Size = None) -> Union[float, ndarray]: ...
    def beta(self, a, b, size: Size = None) -> Union[float, ndarray]: ...
    def exponential(self, scale=1.0, size: Size = None) -> Union[float, ndarray]: ...
    def standard_exponential(self, size: Size = None) -> Union[float, ndarray]: ...
    def tomaxint(self, size: Size = None) -> Union[int, ndarray]: ...
    def randint(
        self, low, high=None, size: Size = None, dtype=int
    ) -> Union[int, ndarray]: ...
    def bytes(self, length: int) -> ndarray: ...
    def choice(self, a, size: Size = None, replace=True, p=None): ...
    def uniform(
    ...
    def standard_normal(self, size: Size = None) -> Union[float, ndarray]: ...
    def normal(
        self, loc=0.0, scale=1.0, size: Size = None
    ) -> Union[float, ndarray]: ...
    def standard_gamma(self, shape, size: Size = None) -> Union[float, ndarray]: ...
    ...
    def binomial(self, n, p, size: Size = None) -> ndarray: ...
    def negative_binomial(self, n, p, size: Size = None) -> ndarray: ...
    ...
    def hypergeometric(self, ngood, nbad, nsample, size: Size = None): ...
    def logseries(self, p, size: Size = None) -> Union[int, ndarray]: ...
    # Multivariate distributions:
    def multivariate_normal(
        self, mean, cov, size: Size = None, check_valid="warn", tol=1e-8
    ) -> ndarray: ...
