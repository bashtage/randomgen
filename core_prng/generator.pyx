...
cdef class RandomGenerator:
    ...
    def random_uintegers(self, size=None, int bits=64):
        ...
        if bits == 64:
            ...
            with self.lock, nogil:
                for i in range(n):
                    data64[i] = self._prng.next_uint64(self._prng.state)
        elif bits == 32:
            if size is None:
                with self.lock:
            ...
            with self.lock, nogil:
                for i in range(n):
                    data32[i] = self._prng.next_uint32(self._prng.state)
        else:
    ...
    def random_raw(self, size=None, output=True):
        ...
        if not output:
            if size is None:
                with self.lock:
                    self._prng.next_raw(self._prng.state)
                return None
        ...
        if size is None:
            with self.lock:
                return self._prng.next_raw(self._prng.state)
        ...
        with self.lock, nogil:
            for i in range(n):
                randoms_data[i] = self._prng.next_raw(self._prng.state)
        return randoms
    ...
    def beta(self, a, b, size=None):
        ...
        """
        return cont(&random_beta, self._prng, size, self.lock, 2,
                    a, 'a', CONS_POSITIVE,
                    b, 'b', CONS_POSITIVE,
                    0.0, '', CONS_NONE, None)
    ...
    def exponential(self, scale=1.0, size=None):
        ...
        """
        return cont(&random_exponential, self._prng, size, self.lock, 1,
    ...
    def tomaxint(self, size=None):
        ...
        for i in range(n):
            with self.lock, nogil:
                randoms_data[i] = random_positive_int(self._prng)
        return randoms
    ...
    def uniform(self, low=0.0, high=1.0, size=None):
        ...
        if np.PyArray_NDIM(alow) == np.PyArray_NDIM(ahigh) == 0:
            ...
            return cont(&random_uniform, self._prng, size, self.lock, 2,
                        _low, '', CONS_NONE,
                        range, '', CONS_NONE,
                        0.0, '', CONS_NONE,
                        None)
    ...
    def gamma(self, shape, scale=1.0, size=None):
        ...
        """
        return cont(&random_gamma, self._prng, size, self.lock, 2,
                    shape, 'shape', CONS_NON_NEGATIVE,
                    scale, 'scale', CONS_NON_NEGATIVE,
                    0.0, '', CONS_NONE, None)
    ...
    def f(self, dfnum, dfden, size=None):
        ...
        """
        return cont(&random_f, self._prng, size, self.lock, 2,
    ...
    def noncentral_f(self, dfnum, dfden, nonc, size=None):
        ...
        """
        return cont(&random_noncentral_f, self._prng, size, self.lock, 3,
                    dfnum, 'dfnum', CONS_POSITIVE,
                    dfden, 'dfden', CONS_POSITIVE,
    ...
    def chisquare(self, df, size=None):
        ...
        """
        return cont(&random_chisquare, self._prng, size, self.lock, 1,
                    df, 'df', CONS_POSITIVE,
                    0.0, '', CONS_NONE,
                    0.0, '', CONS_NONE, None)
    ...
    def noncentral_chisquare(self, df, nonc, size=None):
        ...
        """
        return cont(&random_noncentral_chisquare, self._prng, size, self.lock, 2,
                    df, 'df', CONS_POSITIVE,
    ...
    def standard_cauchy(self, size=None):
        ...
        """
        return cont(&random_standard_cauchy, self._prng, size, self.lock, 0,
    ...
    def standard_t(self, df, size=None):
        ...
        """
        return cont(&random_standard_t, self._prng, size, self.lock, 1,
                    df, 'df', CONS_POSITIVE,
                    0, '', CONS_NONE,
                    0, '', CONS_NONE,
                    None)
    ...
    def vonmises(self, mu, kappa, size=None):
        ...
        """
        return cont(&random_vonmises, self._prng, size, self.lock, 2,
                    mu, 'mu', CONS_NONE,
    ...
    def pareto(self, a, size=None):
        ...
        """
        return cont(&random_pareto, self._prng, size, self.lock, 1,
                    a, 'a', CONS_POSITIVE,
                    0.0, '', CONS_NONE,
                    0.0, '', CONS_NONE, None)
    ...
    def weibull(self, a, size=None):
        ...
        """
        return cont(&random_weibull, self._prng, size, self.lock, 1,
    ...
    def power(self, a, size=None):
        ...
        """
        return cont(&random_power, self._prng, size, self.lock, 1,
                    a, 'a', CONS_POSITIVE,
                    0.0, '', CONS_NONE,
                    0.0, '', CONS_NONE, None)
    ...
    def laplace(self, loc=0.0, scale=1.0, size=None):
        ...
        """
        return cont(&random_laplace, self._prng, size, self.lock, 2,
                    loc, 'loc', CONS_NONE,
                    scale, 'scale', CONS_NON_NEGATIVE,
                    0.0, '', CONS_NONE, None)
    ...
    def gumbel(self, loc=0.0, scale=1.0, size=None):
        ...
        """
        return cont(&random_gumbel, self._prng, size, self.lock, 2,
                    loc, 'loc', CONS_NONE,
                    scale, 'scale', CONS_NON_NEGATIVE,
                    0.0, '', CONS_NONE, None)
    ...
    def logistic(self, loc=0.0, scale=1.0, size=None):
        ...
        """
        return cont(&random_logistic, self._prng, size, self.lock, 2,
                    loc, 'loc', CONS_NONE,
    ...
    def lognormal(self, mean=0.0, sigma=1.0, size=None):
        ...
        *sum* of a large number of independent, identically-distributed
        ...
        """
        return cont(&random_lognormal, self._prng, size, self.lock, 2,
                    mean, 'mean', CONS_NONE,
    ...
    def rayleigh(self, scale=1.0, size=None):
        ...
        """
        return cont(&random_rayleigh, self._prng, size, self.lock, 1,
                    scale, 'scale', CONS_NON_NEGATIVE,
                    0.0, '', CONS_NONE,
                    0.0, '', CONS_NONE, None)
    ...
    def wald(self, mean, scale, size=None):
        ...
        """
        return cont(&random_wald, self._prng, size, self.lock, 2,
    ...
    def triangular(self, left, mode, right, size=None):
        ...
        if np.PyArray_NDIM(oleft) == np.PyArray_NDIM(omode) == np.PyArray_NDIM(oright) == 0:
            ...
            return cont(&random_triangular, self._prng, size, self.lock, 3,
                        fleft, '', CONS_NONE,
                        fmode, '', CONS_NONE,
        ...
        return cont_broadcast_3(&random_triangular, self._prng, size, self.lock,
                            oleft, '', CONS_NONE,
                            omode, '', CONS_NONE,
                            oright, '', CONS_NONE)
    ...
    def negative_binomial(self, n, p, size=None):
        ...
        """
        return disc(&random_negative_binomial, self._prng, size, self.lock, 2, 0,
                        n, 'n', CONS_POSITIVE,
    ...
    def poisson(self, lam=1.0, size=None):
        ...
        """
        return disc(&random_poisson, self._prng, size, self.lock, 1, 0,
    ...
    def zipf(self, a, size=None):
        ...
        """
        return disc(&random_zipf, self._prng, size, self.lock, 1, 0,
                        a, 'a', CONS_GT_1,
                        0.0, '', CONS_NONE,
                        0.0, '', CONS_NONE)
    ...
    def geometric(self, p, size=None):
        ...
        """
        return disc(&random_geometric, self._prng, size, self.lock, 1, 0,
                        p, 'p', CONS_BOUNDED_0_1,
                        0.0, '', CONS_NONE,
                        0.0, '', CONS_NONE)
    ...
    def hypergeometric(self, ngood, nbad, nsample, size=None):
        ...
        if np.PyArray_NDIM(ongood) == np.PyArray_NDIM(onbad) == np.PyArray_NDIM(onsample) == 0:
            ...
            return disc(&random_hypergeometric, self._prng, size, self.lock, 0, 3,
        ...
        if np.any(np.less(np.add(ongood, onbad),onsample)):
            raise ValueError("ngood + nbad < nsample")
        return discrete_broadcast_iii(&random_hypergeometric, self._prng, size, self.lock,
    ...
    def logseries(self, p, size=None):
        ...
        """
        return disc(&random_logseries, self._prng, size, self.lock, 1, 0,
                 p, 'p', CONS_BOUNDED_0_1,
                 0.0, '', CONS_NONE,
                 0.0, '', CONS_NONE)
        ...
        if type(x) is np.ndarray and x.ndim == 1 and x.size:
            ...
            with self.lock:
                for i in reversed(range(1, n)):
                    j = random_interval(self._prng, i)
